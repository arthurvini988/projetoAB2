...
from estoque import Ui_main_Estoque  
import sys
...
"}")   
        ...
        #CHECK FIELDS
                if userError + passError != '':
                        ...
                        estoqueWindow = QtWidgets.QMainWindow()
                        Ui_main_Estoque.setupUi(estoqueWindow)
                        estoqueWindow.show()
        ...
        "}")
                ...
                #BOTÃO LOGIN
                self.pushButton_enviar.clicked.connect(self.checkFields)
